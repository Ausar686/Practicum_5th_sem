...
beta = 2; % коэф смертности жертв за счет поедани€ хищниками
gamma = 0; % коэф смертности хищников
delta = 0; % коэф рождаемости хищников за счЄт поедани€ жертв

x0 = 1000; % начальна€ попул€ци€ жертв
y0 = 20;  % начальна€ попул€ци€ хищников
t0 = 0;
t1 = 5;
tspan = t0:0.01:t1;
...
xlabel('размер попул€ции жертв')
ylabel('размер попул€ции хищников')
